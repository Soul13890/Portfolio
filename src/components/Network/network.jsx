...
function Network() {
  ...
  return (
    <div className='network-container flex gap-4'>
        ...
        <motion.a href="/Portfolio/files/CV.pdf" target="_blank" download="CV.pdf" className="flex justify-center content-center gap-2" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}><MdOutlineFileDownload />Télécharger mon CV</motion.a>
     </div>
  )
}
