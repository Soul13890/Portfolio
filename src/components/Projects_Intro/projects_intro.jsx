...
function Projects_Intro() {
  ...
  return (         
      <section id="my-projects" className='projects-intro-container flex flex-col gap-8 max-w-[1240px] w-full'>
          {window.location.pathname.includes("/projects") && <MotionLink to={`/`} className="flex content-center gap-2 w-fit" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}><IoIosArrowRoundBack />Retour</MotionLink>}
